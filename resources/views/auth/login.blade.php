<x-layouts.auth>
    <div class="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
        ...
        <p class="text-white/60 text-center mb-8">Keep it all together</p>
        ...
        <p class="text-center text-white/50 mt-8">
            Not an account already ? <a href="{{ route('register') }}" class="text-nexus-500 hover:text-nexus-400">Sign Up</a>
        </p>
    </div>
</x-layouts.auth>
