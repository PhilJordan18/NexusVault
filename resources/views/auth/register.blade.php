    ...
    <div class="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
        ...
        <div class="flex justify-center mb-6">
            <div class="w-20 h-20 bg-nexus-500/10 rounded-2xl flex items-center justify-center border border-nexus-500/30">
                <i class="fa-solid fa-fingerprint text-5xl text-nexus-500"></i>
            </div>
        </div>

        <h1 class="text-3xl font-semibold text-center mb-1">Create account</h1>
        <p class="text-white/60 text-center mb-8">Get started in seconds</p>
        ...
        <form method="POST" action="{{ route('register') }}" id="register-form">
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-white/40"><i class="fa-solid fa-user"></i></span>
                    <input type="text" name="name" id="name" class="w-full bg-white/10 border border-white/10 focus:border-nexus-500 rounded-2xl py-4 pl-11 pr-4 text-white placeholder:text-white/40 outline-none transition" placeholder="John Doe" required>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email" class="w-full bg-white/10 border border-white/10 focus:border-nexus-500 rounded-2xl py-4 pl-11 pr-4 text-white placeholder:text-white/40 outline-none transition" placeholder="myemail@service.com" required>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" id="password" class="w-full bg-white/10 border border-white/10 focus:border-nexus-500 rounded-2xl py-4 pl-11 pr-12 text-white placeholder:text-white/40 outline-none transition" placeholder="••••••••" required>
                    <button type="button" id="toggle-password" class="absolute right-4 top-1/2 -translate-y-1/2 text-white/40 hover:text-nexus-500 transition"><i class="fa-solid fa-eye"></i></button>
                </div>
            ...
            <button type="button" id="generate-password"
                    class="w-full flex items-center justify-center gap-2 text-nexus-500 hover:text-nexus-400 text-sm font-medium mb-6 transition">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="/auth/google"
               class="flex items-center justify-center gap-3 border border-white/20 hover:border-white/40 rounded-2xl py-4 transition">
        ...
        <p class="text-center text-white/50 mt-8">
            Already have an account? <a href="{{ route('login') }}" class="text-nexus-500 hover:text-nexus-400">Sign in</a>
        </p>
    </div>
</x-layouts.auth>
