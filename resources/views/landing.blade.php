...
<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-xl border-b border-white/10">
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <!-- Mobile Hamburger -->
        <button @click="open = !open" class="md:hidden text-white p-2 card-link">
    ...
    <div x-show="open"
         ...
         class="md:hidden bg-zinc-950 border-t border-white/10 px-6 py-6">
...
<!-- HERO -->
<div class="relative min-h-[100dvh] flex items-center justify-center pt-20 overflow-hidden">
    <div class="absolute inset-0 bg-[radial-gradient(#27272a_0.8px,transparent_1px)] bg-[length:4px_4px]"></div>
    <div class="flowing-lines"></div>

    <svg class="absolute inset-0 w-full h-full opacity-60" viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="relative z-10 max-w-5xl px-6 text-center">
        ...
        <h1 class="text-7xl md:text-8xl font-semibold tracking-tighter leading-none mb-6">
            Your vault.<br>
        ...
        <p class="max-w-2xl mx-auto text-2xl text-white/70 mb-10">
        ...
        <p class="mt-6 text-xs text-white/50">No credit card required • 14-day Pro trial included</p>
    </div>
        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <div class="mt-10 space-y-6 text-lg text-white/70">
                    <p>All your data is encrypted **locally** on your device with your Master Key before it ever leaves your browser.</p>
                    <p>When you share a password, we use **asymmetric RSA encryption**. The recipient gets a key encrypted with **their** public key.</p>
...
<!-- FOOTER -->
<footer class="bg-zinc-950 border-t border-white/10 py-16">
